...
from A_frist_version_projct.LLM import llm
...
from tools.flights_tools import search_flights, update_ticket_to_new_flight, cancel_ticket,fetch_user_flight_information
...
update_flight_safe_tools = [search_flights,fetch_user_flight_information]
update_flight_sensitive_tools = [update_ticket_to_new_flight, cancel_ticket]

# 合并所有工具
update_flight_tools = update_flight_safe_tools + update_flight_sensitive_tools

book_flight_runnable=prompt|llm.bind_tools(update_flight_tools+[CompleteOrEscalate])
